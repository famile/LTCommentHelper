...
//    YXCitizenAttentionViewController *attenVC = [[YXCitizenAttentionViewController alloc] init];
//    attenVC.citizenId = ID;
//    attenVC.source = type;
//    [vc.navigationController pushViewController:attenVC animated:YES];
//}
